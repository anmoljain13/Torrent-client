...
module.exports = (peers, torrent) => {
    ...
    peers.forEach( async (peer) => download(peer, torrent, pieces, file));
    // fs.closeSync(file);
}
...
function pieceHandler(socket, pieces, queue, torrent, file, pieceResp) {
    ...
    const offset = pieceResp.index * torrent.pieceLength + pieceResp.begin;

    // console.log(offset, pieceResp.index, pieceResp.begin);
